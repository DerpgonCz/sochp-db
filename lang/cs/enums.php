...
return [
    ...
    AnimalTitleEnum::class => [
        ...
        'long' => [
            AnimalTitleEnum::FLAG_CV->value => 'Celostátní vítěz',
            AnimalTitleEnum::FLAG_CH->value => 'Šampion',
            AnimalTitleEnum::FLAG_GCH->value => 'Grandšampion',
            AnimalTitleEnum::FLAG_ICH->value => 'Interšampion',
            AnimalTitleEnum::FLAG_GICH->value => 'Grandinteršamption',
            AnimalTitleEnum::FLAG_SCH->value => 'Superšampion',
        ],
    ],
];
